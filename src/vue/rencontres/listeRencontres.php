            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if(!$r['resultat']): ?>
                            | <a href="../selection/AfficherSelection.php?id_rencontre=<?php echo $r['id_rencontre']; ?>">Feuille de match</a>
                        <?php endif; ?>
                        | <a href="SupprimerUneRencontre.php?id=<?php echo $r['id_rencontre']; ?>" onclick="return confirm('Confirmer ?');">X</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>

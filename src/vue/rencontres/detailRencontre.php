...
<body>
    ...
    <div class="container">
        ...
        <div class="actions">
            ...
            <a href="SaisirResultatEtEvaluations.php?id=<?php echo $rencontre['id_rencontre']; ?>" class="btn">Saisir Résultat / Notes</a>
            <a href="../selection/AfficherSelection.php?id_rencontre=<?php echo $rencontre['id_rencontre']; ?>" class="btn">Gérer la sélection</a>
        </div>
            ...
            <?php else: ?>
                <?php foreach($joueursParticipe as $j): ?>
                    <li>
                        ...
                        <?php if($j['evaluation']) echo "- Note: " . $j['evaluation'] . "/5"; ?>
                    </li>
                <?php endforeach; ?>
            <?php endif; ?>
        </ul>

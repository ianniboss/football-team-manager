...
<html>
<head>
    <title><?php echo isset($rencontre) ? 'Modifier' : 'Ajouter'; ?> un match</title>
...
<body>
    <div class="container">
        ...
        <form method="POST" action="<?php echo isset($rencontre) ? 'ModifierUneRencontre.php' : 'ajouterRencontre.php'; ?>">
            ...
            <input type="text" name="nom_equipe_adverse" value="<?php echo $rencontre['nom_equipe_adverse'] ?? ''; ?>" required><br>

            <label>Lieu :</label>
            <select name="lieu">
                <option value="Domicile" <?php echo (isset($rencontre) && $rencontre['lieu'] == 'Domicile') ? 'selected' : ''; ?>>Domicile</option>

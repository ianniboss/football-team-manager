...
-- Dumping structure for table ftm-projet.commentaire
...
-- Dumping data for table ftm-projet.commentaire: ~0 rows (approximately)
...
-- Dumping structure for table ftm-projet.joueur
...
-- Dumping data for table ftm-projet.joueur: ~8 rows (approximately)
...
-- Dumping structure for table ftm-projet.participer
...
-- Dumping data for table ftm-projet.participer: ~1 rows (approximately)
...
-- Dumping structure for table ftm-projet.rencontre
...
-- Dumping data for table ftm-projet.rencontre: ~6 rows (approximately)
